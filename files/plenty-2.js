...
(function($) {
	...
	$(document).ready(function() {
		...
		$('.dropdown input').focusin(function() {
			if ( plenty.MediaSizeService.interval() != 'xs' && plenty.MediaSizeService.interval() != 'sm' ) $(this).closest('.dropdown').addClass('open');
		}).focusout(function() {
			if ( plenty.MediaSizeService.interval() != 'xs' && plenty.MediaSizeService.interval() != 'sm' ) $(this).closest('.dropdown').removeClass('open');
		});
